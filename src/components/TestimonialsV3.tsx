      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="bg-white/10 backdrop-blur-md border border-cia-brightpurple/20 hover:border-cia-brightpurple/40 transition-all duration-300">
              <CardContent className="p-8">
                <div className="text-center">
                  <div className="mb-6">
                    <svg 
                      className="h-8 w-8 text-cia-brightpurple mx-auto" 
                      fill="currentColor" 
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div>
                    ...
                    <p className="text-cia-brightpurple">{testimonial.position}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
