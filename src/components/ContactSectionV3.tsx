          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-cia-brightpurple/20">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full px-4 py-3 bg-white/10 border border-cia-brightpurple/30 rounded-lg text-white placeholder-gray-400 focus:border-cia-brightpurple focus:outline-none"
              ...
              <div>
                ...
                <textarea 
                  rows={4}
                  className="w-full px-4 py-3 bg-white/10 border border-cia-brightpurple/30 rounded-lg text-white placeholder-gray-400 focus:border-cia-brightpurple focus:outline-none resize-none"
                  placeholder="Your message"
                ></textarea>
              </div>
              <Button 
                type="submit" 
                className="w-full bg-gradient-to-r from-cia-brightpurple to-cia-accent text-white hover:from-cia-accent hover:to-cia-brightpurple"
              >
                Send Message
              </Button>
            </form>
