    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-28 pb-20">
        <div className="container mx-auto py-8 px-4">
          ...
          {formSubmitted ? (
            <div className="max-w-2xl mx-auto text-center bg-green-50 p-8 rounded-lg border border-green-200">
              <svg className="w-16 h-16 text-green-500 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <h3 className="text-2xl font-bold text-aileron-darkblue mb-2">Thank You!</h3>
              ...
              <button 
                ...
                className="px-4 py-2 bg-aileron-blue text-white rounded-md hover:bg-aileron-mediumblue"
              >
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-md border border-blue-200">
                <h3 className="font-semibold text-aileron-darkblue mb-2">Note:</h3>
